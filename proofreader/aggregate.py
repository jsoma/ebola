...
#
# Combine data files into country-specific files
#
...
COUNTRIES = [
    {
        ...
        'filenames': "*.csv",
        'output': "../aggregate_data/drc.csv"
    },
    {
        'path': "../guinea_data",
        'name': "Guinea",
        'filenames': "ebola_guinea_*.csv",
        'output': "../aggregate_data/guinea.csv"
    },
    {
        'path': "../liberia_data",
        'name': "Liberia",
        'filenames': "*.csv",
        'output': "../aggregate_data/libera.csv"
    },
    {
        'path': "../sl_data",
        'name': "Sierra Leone",
        'filenames': "*.csv",
        'output': "../aggregate_data/sierra-leone.csv"
    }
]
...
class CountryCSV:
    ...
    def write_stacked(self):
        ...
        stacked.to_csv(stacked_filename, index=False)
